...
{
    public class AttendanceControllerTests_GetDashbaordData_Continuous_Punches
    {
        ...
        public AttendanceControllerTests_GetDashbaordData_Continuous_Punches()
        {
            ...
            var actual=result;
              ...
              var expected=new UserActivitySummaryDto
             {
                 ...
                 Activity=new List<MainUserActivity> {
                     ...
                     {
                         Color="green",
                         Duration=TimeSpan.Parse("09:03:30"),
                         TimeIn=TimeSpan.Parse("08:00:00"),
                         TimeOut=TimeSpan.Parse("17:03:30"),
                             ...
                             new SubUserActivity
                         {
                             TimeIn=TimeSpan.Parse("09:09:25"),
                             TimeOut=TimeSpan.Parse("09:30:44"),
                             Duration=TimeSpan.Parse("00:44:00"),
                             Color="green",
                             Event="EntertainmentRoom"

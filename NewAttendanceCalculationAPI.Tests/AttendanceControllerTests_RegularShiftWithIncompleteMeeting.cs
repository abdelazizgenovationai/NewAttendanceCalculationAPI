...
{
    public class AttendanceControllerTests_RegularShiftWithIncompleteMeeting
    {
        ...
        public AttendanceControllerTests_RegularShiftWithIncompleteMeeting()
        {
        ...
        public async Task AttendanceController_GenerateAttendanceRecords_ReturnsList()
        {
            ...
            var employeeoOdooList = new List<OdooEmployeeDto>{
                ...
                Calendar =new List<CalendarDto>(){
                    new CalendarDto
                               {
                               DateFrom= $"{shiftTodayDate} 11:00:00",
                               DateTo=$"{shiftTodayDate} 14:00:00",
                               Duration="3 hours",
                               TypeId=CalendarType.Meeting.Id.ToString(),
                               TypeName=CalendarType.Meeting.Name
                                }
                       },
          ...
          new HolidayData
          {
           ...
           .Returns(Task.FromResult(getIncludedEmployeesAndBiometricEventsAsyncResult));
            ...
            expected.TotalSpentTimeOutSideCompanyDuringWorkingHours = TimeSpan.Parse("02:00:00");
            expected.TotalLateTime = TimeSpan.Zero;
            expected.TotalBreakTime = TimeSpan.Parse("01:05:19");
            expected.TotalActualWorkingTime = TimeSpan.Parse("05:58:11");
            ...
            expected.MeetingDuration = TimeSpan.Parse("02:00:00");
            ...
            Assert.Equal(expected.MeetingDuration, actual.MeetingDuration);

...
{
    public class AttendanceControllerTests_OvertimeEndingOnTheSameDay
    {
        ...
        public AttendanceControllerTests_OvertimeEndingOnTheSameDay()
        {
        ...
        public async Task AttendanceController_GenerateAttendanceRecords_ReturnsList()
        {
          ...
          new HolidayData
          {
           ...
           .Returns(Task.FromResult(getIncludedEmployeesAndBiometricEventsAsyncResult));
            ...
            expected.TotalOverTime = TimeSpan.Parse("02:03:30");
            ...
            expected.TotalActualWorkingTime = TimeSpan.Parse("09:58:11");
            expected.TotalTimeWorkedWithMeetings = TimeSpan.Parse("09:58:11");
